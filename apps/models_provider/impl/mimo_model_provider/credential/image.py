...
"""
    @project: maxkb
    @file: image.py
    @desc: MiMo Vision / Image Understanding credential
"""
...
class MiMoImageModelParams(BaseForm):
...
class MiMoImageModelCredential(BaseForm, BaseModelCredential):
