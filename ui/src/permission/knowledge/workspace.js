...
const workspace = {
    is_share: () => hasPermission(new ComplexPermission([RoleConst.USER.getWorkspaceRole, RoleConst.WORKSPACE_MANAGE.getWorkspaceRole], [
    ...
    vector: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    generate: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    relate_map: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.KNOWLEDGE_RELATE_RESOURCE_VIEW.getKnowledgeWorkspaceResourcePermission(source_id),
    ...
    doc_read: () => false,
    jump_read: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_create: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_vector: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_generate: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_migrate: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_sync: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_delete: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_export: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_download: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_tag: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    doc_replace: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    knowledge_chat_user_read: (source_id) => false,
    knowledge_chat_user_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    problem_read: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    problem_create: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    problem_relate: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    problem_delete: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    problem_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    termbase_read: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    termbase_create: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    termbase_delete: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    termbase_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    tag_read: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    tag_create: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    tag_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    tag_delete: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    chat_user_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.KNOWLEDGE_CHAT_USER_EDIT.getKnowledgeWorkspaceResourcePermission(source_id),
        PermissionConst.KNOWLEDGE_CHAT_USER_EDIT.getWorkspacePermissionWorkspaceManageRole,
    ], 'OR'),
    debug: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.KNOWLEDGE_WORKFLOW_READ.getKnowledgeWorkspaceResourcePermission(source_id),
        PermissionConst.KNOWLEDGE_WORKFLOW_READ.getWorkspacePermissionWorkspaceManageRole,
    ], 'OR'),
    workflow_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    workflow_export: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
