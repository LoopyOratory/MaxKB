...
const workspace = {
    ...
    jump_read: () => false,
    is_share: () => hasPermission(new ComplexPermission([
        RoleConst.ADMIN,
        RoleConst.USER.getWorkspaceRole,
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ], [
    ...
    folderCreate: (folder_id) => hasPermission([
    ...
    folderRead: (folder_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(folder_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    folderEdit: (folder_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(folder_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    folderAuth: (folder_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(folder_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    folderDelete: (folder_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(folder_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    folderManage: () => true,
    delete: (source_id) => hasPermission([
    ...
    record: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    trigger_read: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    trigger_create: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    trigger_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    trigger_delete: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    switch: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.TOOL_EDIT.getToolWorkspaceResourcePermission(source_id),
        PermissionConst.TOOL_EDIT.getWorkspacePermissionWorkspaceManageRole,
    ], 'OR'),
    copy: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.TOOL_EDIT.getToolWorkspaceResourcePermission(source_id),
        PermissionConst.TOOL_EDIT.getWorkspacePermissionWorkspaceManageRole,
    ], 'OR'),
    publish: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    export: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    relate_map: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.TOOL.getToolWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
