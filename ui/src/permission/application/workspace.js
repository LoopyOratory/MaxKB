...
const workspace = {
    ...
    batchCleanStrategy: () => hasPermission([
        RoleConst.USER.getWorkspaceRole,
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    relate_map: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_RELATE_RESOURCE_VIEW.getApplicationWorkspaceResourcePermission(source_id),
    ...
    folderManage: (folder_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(folder_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
        PermissionConst.APPLICATION_FOLDER_EDIT.getApplicationWorkspaceResourcePermission(folder_id),
        PermissionConst.APPLICATION_FOLDER_EDIT.getWorkspacePermissionWorkspaceManageRole,
    ...
    overview_embed: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    overview_access: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    overview_display: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    overview_api_key: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    access_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    application_chat_user_edit: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    chat_log_add_knowledge: (source_id) => hasPermission([
        new ComplexPermission([RoleConst.USER], [PermissionConst.APPLICATION.getApplicationWorkspaceResourcePermission(source_id)], [], 'AND'),
        RoleConst.WORKSPACE_MANAGE.getWorkspaceRole,
    ...
    jump_read: (source_id) => hasPermission([
        ...
        PermissionConst.APPLICATION_READ.getWorkspacePermissionWorkspaceManageRole,
        PermissionConst.APPLICATION_OVERVIEW_READ.getApplicationWorkspaceResourcePermission(source_id),
        PermissionConst.APPLICATION_READ.getApplicationWorkspaceResourcePermission(source_id),
    ], 'OR'),
    access_read: () => false,
