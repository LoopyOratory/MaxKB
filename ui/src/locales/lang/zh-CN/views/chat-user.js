export default {
    ...
    knowledgeTitleTip: 'This configuration will only take effect after enabling chat user login authentication in the associated agent',
    applicationTitleTip: 'This configuration requires login authentication to be enabled in the agent',
