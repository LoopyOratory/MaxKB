export default {
    ...
    batchClearStrategyTip: 'This operation will batch update the chat log clear policy for the selected agents.',
    simple: 'SIMPLE',
    senior: 'WORKFLOW',
    ...
    advancedPlaceholder: 'Using low-code drag-and-drop methods, flexibly orchestrate complex logic and feature-rich agents',
    ...
    delete: {
        ...
        confirmMessage: 'Deleting this agent will no longer provide its services. Please proceed with caution.',
    ...
    tip: {
        ...
        professionalMessage: 'The Community Edition supports up to 5 agents. If you need more agents, please upgrade to the Professional Edition.',
...
After disabling, the long-term memory of the conversation users will be cleared, and re-enabling will resume accumulation from the activation point.`,
    ...
    form: {
        ...
        appDescription: {
            placeholder: 'Describe the Agent scenario and use, e.g.: XXX assistant answering user questions about XXX product usage',
        },
        appIcon: 'Agent Icon',
        userIcon: 'User Icon',
        appType: {
        ...
        roleSettings: {
            label: 'System Prompt',
            placeholder: 'System prompt, you can reference variables in the system: {data} is the segment hit in the knowledge base; {question} is the question asked by the user, {memory} is the user memory after enabling long-term memory.',
        ...
        prompt: {
            ...
            placeholder: 'User prompt, you can reference variables in the system: {data} is the segment hit in the knowledge base; {question} is the question asked by the user',
            requiredMessage: 'Please enter User prompt',
            tooltip: 'The question or command that the user poses to the model',
            noReferencesTooltip: 'By adjusting the content of the prompt, you can guide the direction of the large model chat. This prompt will be fixed at the beginning of the context. Variables used: {question} is the question posed by the user.',
            referencesTooltip: 'By adjusting the content of the prompt, you can guide the direction of the large model chat. This prompt will be fixed at the beginning of the context. Variables used: {data} carries known information from the knowledge; {question} is the question posed by the user.',
        ...
        reasoningContent: {
            ...
            tooltip: "Please set the thinking label based on the model's return, and the content in the middle of the label will be recognized as the thinking process.",
            start: 'Start',
            end: 'End',
        },
    ...
    dialog: {
        ...
        vectorSearchTooltip: 'Vector search is a retrieval method based on vector distance calculations, suitable for large data volumes in the knowledge.',
        fullTextSearch: 'Full-text Search',
        fullTextSearchTooltip: 'Full-text search is a retrieval method based on text similarity, suitable for small data volumes in the knowledge.',
        hybridSearch: 'Hybrid Search',
        hybridSearchTooltip: 'Hybrid search is a retrieval method based on both vector and text similarity, suitable for medium data volumes in the knowledge.',
        ...
        designated_answer: 'Hello, I am XXX Assistant. My knowledge only contains information related to XXX products. Please rephrase your question.',
        defaultPrompt1: "The content inside the parentheses () represents the user's question. Based on the context, please speculate and complete the user's question ({question}). The requirement is to output a completed question and place it",
        defaultPrompt2: 'tag',
    },
    applicationAccess: {
        ...
        wecomSetting: {
            ...
            urlInfo: '-APP management-Self-built-Created APP-Receive messages-Set the "URL" received by the API',
        },
        dingtalkSetting: {
            title: 'DingTalk Configuration',
            clientIdPlaceholder: 'Please enter client ID',
            clientSecretPlaceholder: 'Please enter client secret',
            urlInfo: '-On the robot page, set the "Message Receiving Mode" to HTTP mode, and fill in the above URL into the "Message Receiving Address"',
        },
        wechatSetting: {
            ...
            urlInfo: '-Settings and Development-Basic Configuration-"Server Address URL" in server configuration',
        },
        wecomBotSetting: {
        ...
        larkSetting: {
            ...
            urlInfo: '-Events and callbacks - event configuration - configure the "request address" of the subscription method',
        },
        slackSetting: {
