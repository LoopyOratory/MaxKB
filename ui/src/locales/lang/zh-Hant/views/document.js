export default {
    ...
    tip: {
        ...
        exportSimultaneouslyTip: 'By checking this option, the original files will be packaged together with the ZIP file, allowing automatic restoration of file associations upon import; if unchecked, only the text content will be exported.',
        ...
        toImportDocConfirm: 'The workflow of the current knowledge base is not published, and documents cannot be imported. Please publish the workflow first.',
