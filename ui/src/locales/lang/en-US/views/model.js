export default {
    ...
    delete: {
        ...
        confirmMessage: 'Deleting the model will affect the resources currently using it. Please proceed with caution.',
    ...
    modelForm: {
        ...
        model_type: {
            ...
            tooltip5: 'Rerank: A model used to reorder candidate segments when using multi-route recall in advanced orchestration agent.',
            tooltip6: 'Vision Model: A visual model used for image understanding in advanced orchestration agent.',
            tooltip7: 'Image Generation: A visual model used for image generation in advanced orchestration agent.',
