export default {
    ...
    tip: {
        professionalMessage: 'The community edition supports up to 50 knowledge. For more knowledge, please upgrade to the professional edition.',
        syncSuccess: 'Sync task sent successfully',
        updateModeMessage: 'After modifying the knowledge vector model, you need to vectorize the knowledge. Do you want to continue saving?',
    },
    delete: {
    ...
    form: {
        ...
        knowledgeDescription: {
            label: 'Description',
            placeholder: 'Describe the content of the knowledge. A detailed description will help AI understand the content better, improving the accuracy of content retrieval and hit rate.',
    ...
    transform: {
        ...
        message1: "You can now convert your existing knowledge base into a workflow knowledge base—a more open and flexible type that allows you to autonomously orchestrate the entire process from various data sources to knowledge base writing through drag-and-drop node operations, meeting your enterprise's personalized knowledge management needs. You can utilize the data sources and tools available in our suite. ",
        ...
        confirm: 'Are you sure you want to convert to the workflow knowledge base? This action cannot be undone. Please proceed with caution.',
    },
    customSegmentation: {
        title: 'Custom Term',
        ...
        word: 'Term',
        wordplaceholder: 'Please enter the professional terms/unique vocabulary to retain, one per line',
