...
const postParagraph = (knowledge_id, document_id, data, loading) => {
    return post(`${prefix}/${knowledge_id}/document/${document_id}/paragraph`, data, undefined, loading);
};
/**
 * ParagraphList
...
const getParagraphPage = (knowledge_id, document_id, page, param, loading) => {
    return get(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/${page.current_page}/${page.page_size}`, param, loading);
};
/**
...
const putParagraph = (knowledge_id, document_id, paragraph_id, data, loading) => {
    return put(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/${paragraph_id}`, data, undefined, loading);
};
/**
 * DeletionParagraph
...
const delParagraph = (knowledge_id, document_id, paragraph_id, loading) => {
    return del(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/${paragraph_id}`, undefined, {}, loading);
};
/**
...
const postParagraphProblem = (knowledge_id, document_id, paragraph_id, data, loading) => {
    return post(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/${paragraph_id}/problem`, data, {}, loading);
};
/**
 * ParagraphReorder
...
const putAdjustPosition = (knowledge_id, document_id, data, loading) => {
    return put(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/adjust_position`, {}, data, loading);
};
/**
...
const putAssociationProblem = (knowledge_id, document_id, data, loading) => {
    return put(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/association`, {}, data, loading);
};
/**
...
const putMulParagraph = (knowledge_id, document_id, data, loading) => {
    return put(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/batch_delete`, { id_list: data }, undefined, loading);
};
/**
...
const putBatchGenerateRelated = (knowledge_id, document_id, data, loading) => {
    return put(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/batch_generate_related`, data, undefined, loading);
};
/**
...
const putMigrateMulParagraph = (knowledge_id, document_id, target_knowledge_id, target_document_id, data, loading) => {
    return put(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/migrate/knowledge/${target_knowledge_id}/document/${target_document_id}`, data, undefined, loading);
};
/**
...
const putDisassociationProblem = (knowledge_id, document_id, data, loading) => {
    return put(`${prefix}/${knowledge_id}/document/${document_id}/paragraph/unassociation`, {}, data, loading);
};
export default {
    postParagraph,
    getParagraphPage,
