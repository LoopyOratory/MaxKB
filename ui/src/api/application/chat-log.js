...
const getChatLog = (application_id, page, param, loading) => {
    return get(`${prefix.value}/${application_id}/chat/${page.current_page}/${page.page_size}`, param, loading);
};
/**
...
const getChatRecordLog = (application_id, chart_id, page, loading, order_asc) => {
    return get(`${prefix.value}/${application_id}/chat/${chart_id}/chat_record/${page.current_page}/${page.page_size}`, { order_asc: order_asc !== undefined ? order_asc : true }, loading);
};
/**
...
const getMarkChatRecord = (application_id, chart_id, chart_record_id, loading) => {
    return get(`${prefix.value}/${application_id}/chat/${chart_id}/chat_record/${chart_record_id}/improve`, undefined, loading);
};
/**
...
const putChatRecordLog = (application_id, chart_id, chart_record_id, knowledge_id, document_id, data, loading) => {
    return put(`${prefix.value}/${application_id}/chat/${chart_id}/chat_record/${chart_record_id}/knowledge/${knowledge_id}/document/${document_id}/improve`, data, undefined, loading);
};
/**
 * DeletionAnnotation
 * @param Parameters
...
const delMarkChatRecord = (application_id, chart_id, chart_record_id, knowledge_id, document_id, paragraph_id, loading) => {
    return del(`${prefix.value}/${application_id}/chat/${chart_id}/chat_record/${chart_record_id}/knowledge/${knowledge_id}/document/${document_id}/paragraph/${paragraph_id}/improve`, undefined, {}, loading);
};
/**
...
const postExportChatLog = (application_id, application_name, param, data, loading) => {
    exportExcelPost(application_name + '.xlsx', `${prefix.value}/${application_id}/chat/export`, param, data, loading);
};
const getChatRecordDetails = (application_id, chat_id, chat_record_id, loading) => {
    return get(`${prefix.value}/${application_id}/chat/${chat_id}/chat_record/${chat_record_id}`, {}, loading);
};
export default {
