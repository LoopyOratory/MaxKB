import { get, post, postStream, del, put, download, exportFile } from '@/request/index';
 ...
 * @returns
 */
const generate_prompt = (application_id, model_id, data) => {
...
const exportApplication = (application_id, application_name, loading) => {
    return exportFile(application_name + '.mk', `${prefix}/${application_id}/export`, undefined, loading);
};
/**
 * ImportApplication
 */
const importApplication = (data, loading) => {
 ...
 * mcp Node
 */
const getMcpTools = (application_id, loading) => {
