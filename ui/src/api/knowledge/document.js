import { del, exportExcel, exportExcelPost, exportFile, exportFilePost, get, post, put } from '@/request/index';
...
const getDocumentPage = (knowledge_id, page, param, loading) => {
    return get(`${prefix.value}/${knowledge_id}/document/${page.current_page}/${page.page_size}`, param, loading);
};
/**
 * DocumentDetails
 * @param Parameters knowledge_id
...
const getDocumentDetail = (knowledge_id, document_id, loading) => {
    return get(`${prefix.value}/${knowledge_id}/document/${document_id}`, {}, loading);
};
/**
...
const putCancelTask = (knowledge_id, document_id, data, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/${document_id}/cancel_task`, data, undefined, loading);
};
/**
...
const exportDocument = (document_name, knowledge_id, document_id, loading) => {
    return exportExcel(document_name.trim() + '.xlsx', `${prefix.value}/${knowledge_id}/document/${document_id}/export`, {}, loading);
};
const exportMulDocument = (document_name, knowledge_id, document_ids, loading) => {
    return exportExcelPost(document_name.trim() + '.xlsx', `${prefix.value}/${knowledge_id}/document/batch_export`, {}, document_ids, loading);
};
/**
 * ExportDocument
 * @param document_name DocumentName
...
const exportDocumentZip = (document_name, knowledge_id, document_id, loading) => {
    return exportFile(document_name.trim() + '.zip', `${prefix.value}/${knowledge_id}/document/${document_id}/export_zip`, {}, loading);
};
const exportMulDocumentZip = (document_name, knowledge_id, document_ids, loading) => {
    return exportFilePost(document_name.trim() + '.zip', `${prefix.value}/${knowledge_id}/document/batch_export_zip`, {}, document_ids, loading);
};
/**
...
const putDocumentRefresh = (knowledge_id, document_id, state_list, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/${document_id}/refresh`, { state_list }, undefined, loading);
};
const putDocumentTokenize = (knowledge_id, document_id, state_list, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/${document_id}/tokenize`, { state_list }, undefined, loading);
};
/**
 * SyncwebSiteType
 * @param Parameters
...
const putDocumentSync = (knowledge_id, document_id, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/${document_id}/sync`, undefined, undefined, loading);
};
/**
...
const delMulDocument = (knowledge_id, data, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/batch_delete`, { id_list: data }, undefined, loading);
};
/**
 * BatchAssociation
 * @param Parameters knowledge_id,
...
const putBatchRefresh = (knowledge_id, data, stateList, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/batch_refresh`, { id_list: data, state_list: stateList }, undefined, loading);
};
const putBatchTokenize = (knowledge_id, data, stateList, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/batch_tokenize`, { id_list: data, state_list: stateList }, undefined, loading);
};
/**
 * BatchSyncDocument
 * @param Parameters knowledge_id,
...
const putMigrateMulDocument = (knowledge_id, target_knowledge_id, data, loading) => {
    return put(`${prefix.value}/${knowledge_id}/document/migrate/${target_knowledge_id}`, data, undefined, loading);
};
/**
 * ImportQADocument
 * @param Parameters
...
const postSplitDocument = (knowledge_id, data) => {
    return post(`${prefix.value}/${knowledge_id}/document/split`, data, undefined, undefined, 1000 * 60 * 60);
};
/**
...
const exportTableTemplate = (fileName, type, loading) => {
    return exportExcel(fileName, `/workspace/knowledge/document/table_template/export`, { type }, loading);
};
/**
...
const getLarkDocumentList = (knowledge_id, folder_token, data, loading) => {
    return post(`${prefix.value}/lark/${knowledge_id}/${folder_token}/doc_list`, data, undefined, loading);
};
/**
 * SyncFeishuDocument
 */
const putLarkDocumentSync = (knowledge_id, document_id, loading) => {
    return put(`${prefix.value}/lark/${knowledge_id}/document/${document_id}/sync`, undefined, undefined, loading);
};
/**
