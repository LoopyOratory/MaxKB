...
const pageToolRecord = (tool_id, page, param, loading) => {
    return get(`${prefix.value}/${tool_id}/tool_record/${page.current_page}/${page.page_size}`, param, loading);
};
 ...
 * mcp Node
 */
const getMcpTools = (tool_id, mcp_servers, loading) => {
 ...
 */
const putMulMoveTool = (data, loading) => {
