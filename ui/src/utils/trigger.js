...
export function getTriggerCycleLabel(data) {
    ...
    switch (schedule_type) {
        ...
        case 'weekly':
            if (days && time) {
                const dayOption = scheduleOption.children.find((day) => day.value.toString() === days.toString());
                if (dayOption) {
        ...
        case 'interval':
            if (interval_unit) {
                const unitOption = scheduleOption.children.find((unit) => unit.value === interval_unit);
                if (unitOption) {
