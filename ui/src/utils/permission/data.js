...
const PermissionConst = {
    ...
    RESOURCE_KNOWLEDGE_TERMBASE_CREATE: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+CREATE'),
    RESOURCE_KNOWLEDGE_TERMBASE_EDIT: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+EDIT'),
    RESOURCE_KNOWLEDGE_TERMBASE_DELETE: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+DELETE'),
    RESOURCE_KNOWLEDGE_TERMBASE_EXPORT: new Permission('SYSTEM_RESOURCE_KNOWLEDGE_TERMBASE:READ+EXPORT'),
    ...
    APPLICATION_WORKSPACE_USER_RESOURCE_PERMISSION_READ: new Permission('APPLICATION_WORKSPACE_USER_RESOURCE_PERMISSION:READ'),
    KNOWLEDGE_WORKSPACE_USER_RESOURCE_PERMISSION_READ: new Permission('KNOWLEDGE_WORKSPACE_USER_RESOURCE_PERMISSION:READ'),
    TOOL_WORKSPACE_USER_RESOURCE_PERMISSION_READ: new Permission('TOOL_WORKSPACE_USER_RESOURCE_PERMISSION:READ'),
    MODEL_WORKSPACE_USER_RESOURCE_PERMISSION_READ: new Permission('MODEL_WORKSPACE_USER_RESOURCE_PERMISSION:READ'),
    APPLICATION_WORKSPACE_USER_RESOURCE_PERMISSION_EDIT: new Permission('APPLICATION_WORKSPACE_USER_RESOURCE_PERMISSION:READ+EDIT'),
    KNOWLEDGE_WORKSPACE_USER_RESOURCE_PERMISSION_EDIT: new Permission('KNOWLEDGE_WORKSPACE_USER_RESOURCE_PERMISSION:READ+EDIT'),
    TOOL_WORKSPACE_USER_RESOURCE_PERMISSION_EDIT: new Permission('TOOL_WORKSPACE_USER_RESOURCE_PERMISSION:READ+EDIT'),
    MODEL_WORKSPACE_USER_RESOURCE_PERMISSION_EDIT: new Permission('MODEL_WORKSPACE_USER_RESOURCE_PERMISSION:READ+EDIT'),
};
const RoleConst = {
