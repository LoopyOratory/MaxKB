...
import { getMenuNodes, toolLibNode, applicationNode, toolWorkflowLibNode, } from '@/workflow/common/data';
...
function clickNodes(item, data, type) {
    if (data) {
...
async function getApplicationList() {
    ...
    applicationList.value = res.data.filter((item) => item.resource_type === 'application' && item.id !== props.id && item.is_publish);
}
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    ...{ style: ({ width: __VLS_ctx.activeName === 'base' ? '400px' : '640px' }) },
});
...
const { default: __VLS_13 } = __VLS_11.slots;
{
    ...
    // @ts-ignore
    [activeName, activeName, activeName, show, handleClick, search_text, $t,];
    var __VLS_18;
    // @ts-ignore
    [];
}
...
const { default: __VLS_85 } = __VLS_83.slots;
{
    ...
    var __VLS_91;
    // @ts-ignore
    [$t, $t, SourceTypeEnum, toolTreeData, folder, permissionPrecise, folderClickHandle,];
}
let __VLS_94;
/** @ts-ignore @type { | typeof __VLS_components.elScrollbar | typeof __VLS_components.ElScrollbar | typeof __VLS_components['el-scrollbar'] | typeof __VLS_components.elScrollbar | typeof __VLS_components.ElScrollbar | typeof __VLS_components['el-scrollbar']} */
elScrollbar;
...
const __VLS_106 = {
    ...
    onClickNodes: ((val) => __VLS_ctx.clickNodes(val.tool_type === 'WORKFLOW' ? __VLS_ctx.toolWorkflowLibNode : __VLS_ctx.toolLibNode, val, 'tool')),
};
const __VLS_107 = {
    /** @type {typeof __VLS_105.onmousedown} */
    onOnmousedown: ((val) => __VLS_ctx.onmousedown(val.tool_type === 'WORKFLOW' ? __VLS_ctx.toolWorkflowLibNode : __VLS_ctx.toolLibNode, val, 'tool')),
};
var __VLS_103;
var __VLS_104;
// @ts-ignore
...
{
    const { left: __VLS_120 } = __VLS_117.slots;
    let __VLS_121;
    /** @ts-ignore @type { | typeof __VLS_components.FolderVirtualizedTree} */
    FolderVirtualizedTree;
    // @ts-ignore
    const __VLS_122 = __VLS_asFunctionalComponent1(__VLS_121, new __VLS_121({
        ...
        data: (__VLS_ctx.applicationTreeData),
        currentNodeKey: (__VLS_ctx.folder.currentFolder?.id),
        canOperation: (false),
        treeStyle: ({ height: '400px' }),
    }));
    ...
    let __VLS_126;
    const __VLS_127 = {
        /** @type {typeof __VLS_126.handleNodeClick} */
        onHandleNodeClick: (__VLS_ctx.folderClickHandle),
    };
    var __VLS_124;
    var __VLS_125;
    // @ts-ignore
    [$t, SourceTypeEnum, folder, folderClickHandle, applicationTreeData,];
}
let __VLS_128;
/** @ts-ignore @type { | typeof __VLS_components.elScrollbar | typeof __VLS_components.ElScrollbar | typeof __VLS_components['el-scrollbar'] | typeof __VLS_components.elScrollbar | typeof __VLS_components.ElScrollbar | typeof __VLS_components['el-scrollbar']} */
elScrollbar;
...
const __VLS_134 = NodeContent;
// @ts-ignore
const __VLS_135 = __VLS_asFunctionalComponent1(__VLS_134, new __VLS_134({
    ...{ 'onClickNodes': {} },
    ...{ 'onOnmousedown': {} },
    list: (__VLS_ctx.applicationList),
}));
...
let __VLS_139;
const __VLS_140 = {
    /** @type {typeof __VLS_139.clickNodes} */
    onClickNodes: ((val) => __VLS_ctx.clickNodes(__VLS_ctx.applicationNode, val, 'application')),
};
const __VLS_141 = {
    /** @type {typeof __VLS_139.onmousedown} */
    onOnmousedown: ((val) => __VLS_ctx.onmousedown(__VLS_ctx.applicationNode, val, 'application')),
};
var __VLS_137;
var __VLS_138;
// @ts-ignore
[clickNodes, onmousedown, applicationList, applicationNode, applicationNode,];
var __VLS_131;
// @ts-ignore
[];
var __VLS_117;
