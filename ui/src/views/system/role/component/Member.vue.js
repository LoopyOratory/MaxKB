...
async function getList() {
    try {
        ...
        const res = await loadPermissionApi('role').getRoleMemberList(props.currentRole?.id, paginationConfig, params, loading);
...
function handleDelete(row) {
    MsgConfirm(`${t('views.role.member.delete.confirmTitle')}${row.nick_name} ?`, '', {
        ...
        loadPermissionApi('role')
            .deleteRoleMember(props.currentRole?.id, row.user_relation_id, loading)
            .then(() => {
...
__VLS_asFunctionalDirective(__VLS_directives.vHasPermission, {})(null, { ...__VLS_directiveBindingRestFields, value: (new __VLS_ctx.ComplexPermission([__VLS_ctx.RoleConst.ADMIN, __VLS_ctx.RoleConst.WORKSPACE_MANAGE], [__VLS_ctx.PermissionConst.WORKSPACE_ROLE_ADD_MEMBER, __VLS_ctx.PermissionConst.ROLE_ADD_MEMBER], [], 'OR')) }, null, null);
...
const __VLS_39 = __VLS_asFunctionalComponent1(__VLS_38, new __VLS_38({
    ...{ 'onSizeChange': {} },
    ...{ 'onChangePage': {} },
    ...{ class: (`${props.currentRole?.type !== __VLS_ctx.RoleTypeEnum.ADMIN ? 'member-table' : ''} mt-16`) },
...
if (props.currentRole?.type !== __VLS_ctx.RoleTypeEnum.ADMIN) {
    let __VLS_57;
    /** @ts-ignore @type { | typeof __VLS_components.elTableColumn | typeof __VLS_components.ElTableColumn | typeof __VLS_components['el-table-column']} */
    elTableColumn;
    // @ts-ignore
    const __VLS_58 = __VLS_asFunctionalComponent1(__VLS_57, new __VLS_57({
        prop: "workspace_name",
        label: (__VLS_ctx.$t('views.role.member.workspace')),
    }));
...
const { default: __VLS_67 } = __VLS_65.slots;
{
    ...
    const __VLS_81 = {
        ...
        onClick: (...[$event]) => {
            ...
            // @ts-ignore
            [$t, $t, $t, $t, $t, $t, $t, searchType, searchType, searchForm, searchForm, getList, getList, getList, RoleTypeEnum, RoleTypeEnum, tableData, paginationConfig, objectSpanMethod, handleSizeChange, vLoading, loading, handleDelete,];
        },
    };
    __VLS_asFunctionalDirective(__VLS_directives.vHasPermission, {})(null, { ...__VLS_directiveBindingRestFields, value: (new __VLS_ctx.ComplexPermission([__VLS_ctx.RoleConst.ADMIN, __VLS_ctx.RoleConst.WORKSPACE_MANAGE], [
            __VLS_ctx.PermissionConst.ROLE_REMOVE_MEMBER,
            __VLS_ctx.PermissionConst.WORKSPACE_ROLE_REMOVE_MEMBER,
        ], [], 'OR')) }, null, null);
