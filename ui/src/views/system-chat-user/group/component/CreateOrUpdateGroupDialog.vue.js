...
const submit = async (formEl) => {
    ...
    await formEl.validate((valid) => {
        if (valid) {
            loadPermissionApi('userGroup').postUserGroup(form.value, loading).then((res) => {
...
const __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    title: (`${!__VLS_ctx.form.id ? __VLS_ctx.$t('common.create') : __VLS_ctx.$t('common.rename')}${__VLS_ctx.$t('views.chatUser.group.title')}`),
...
const __VLS_18 = __VLS_asFunctionalComponent1(__VLS_17, new __VLS_17({
    label: (__VLS_ctx.$t('views.chatUser.group.name')),
    prop: "name",
}));
...
const __VLS_24 = __VLS_asFunctionalComponent1(__VLS_23, new __VLS_23({
    ...
    maxlength: "128",
    showWordLimit: true,
    placeholder: (`${__VLS_ctx.$t('common.inputPlaceholder')}${__VLS_ctx.$t('views.chatUser.group.name')}`),
}));
