...
function getDetail() {
    authApi.getAuthSetting(form.value.auth_type, loading).then((res) => {
        if (res.data && JSON.stringify(res.data) !== '{}') {
            form.value = res.data;
            if (form.value.config.fieldMapping === '' ||
...
const __VLS_15 = __VLS_asFunctionalComponent1(__VLS_14, new __VLS_14({
    label: (__VLS_ctx.$t('views.system.authentication.oidc.authEndpoint')),
...
const __VLS_21 = __VLS_asFunctionalComponent1(__VLS_20, new __VLS_20({
    ...
    placeholder: (__VLS_ctx.$t('views.system.authentication.oidc.authEndpointPlaceholder')),
}));
...
const __VLS_26 = __VLS_asFunctionalComponent1(__VLS_25, new __VLS_25({
    label: (__VLS_ctx.$t('views.system.authentication.oidc.tokenEndpoint')),
...
const __VLS_32 = __VLS_asFunctionalComponent1(__VLS_31, new __VLS_31({
    ...
    placeholder: (__VLS_ctx.$t('views.system.authentication.oidc.tokenEndpointPlaceholder')),
}));
...
const __VLS_37 = __VLS_asFunctionalComponent1(__VLS_36, new __VLS_36({
    label: (__VLS_ctx.$t('views.system.authentication.oidc.userInfoEndpoint')),
...
const __VLS_43 = __VLS_asFunctionalComponent1(__VLS_42, new __VLS_42({
    ...
    placeholder: (__VLS_ctx.$t('views.system.authentication.oidc.userInfoEndpointPlaceholder')),
}));
...
const __VLS_65 = __VLS_asFunctionalComponent1(__VLS_64, new __VLS_64({
    modelValue: (__VLS_ctx.form.config.state),
    placeholder: "",
}));
...
const __VLS_70 = __VLS_asFunctionalComponent1(__VLS_69, new __VLS_69({
    label: (__VLS_ctx.$t('views.system.authentication.oidc.clientId')),
...
const __VLS_76 = __VLS_asFunctionalComponent1(__VLS_75, new __VLS_75({
    ...
    placeholder: (__VLS_ctx.$t('views.system.authentication.oidc.clientIdPlaceholder')),
}));
...
const __VLS_81 = __VLS_asFunctionalComponent1(__VLS_80, new __VLS_80({
    label: (__VLS_ctx.$t('views.system.authentication.oidc.clientSecret')),
...
const __VLS_87 = __VLS_asFunctionalComponent1(__VLS_86, new __VLS_86({
    ...
    placeholder: (__VLS_ctx.$t('views.system.authentication.oidc.clientSecretPlaceholder')),
    showPassword: true,
}));
...
const __VLS_103 = __VLS_asFunctionalComponent1(__VLS_102, new __VLS_102({
    label: (__VLS_ctx.$t('views.system.authentication.oidc.redirectUrl')),
...
const __VLS_109 = __VLS_asFunctionalComponent1(__VLS_108, new __VLS_108({
    ...
    placeholder: (__VLS_ctx.$t('views.system.authentication.oidc.redirectUrlPlaceholder')),
}));
...
(__VLS_ctx.$t('views.system.authentication.oidc.enableAuthentication'));
// @ts-ignore
[form, $t,];
var __VLS_122;
// @ts-ignore
...
__VLS_asFunctionalDirective(__VLS_directives.vHasPermission, {})(null, { ...__VLS_directiveBindingRestFields, value: (new __VLS_ctx.ComplexPermission([__VLS_ctx.RoleConst.ADMIN], [__VLS_ctx.PermissionConst.CHAT_USER_AUTH_EDIT], [], 'OR')) }, null, null);
