...
const __VLS_24 = __VLS_asFunctionalComponent1(__VLS_23, new __VLS_23({
    label: (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.model.label')),
    ...
    rules: ({
        ...
        message: __VLS_ctx.form_data.model_id_type === 'reference'
            ...
            : __VLS_ctx.$t('workflow.nodes.imageGenerateNode.model.requiredMessage'),
        trigger: 'change',
    }),
}));
...
const { default: __VLS_28 } = __VLS_26.slots;
{
    ...
    (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.model.label'));
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "color-danger" },
    });
...
if (__VLS_ctx.form_data.model_id_type !== 'reference') {
    ...
    const __VLS_49 = __VLS_asFunctionalComponent1(__VLS_48, new __VLS_48({
        ...
        placeholder: (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.model.requiredMessage')),
...
const __VLS_85 = __VLS_asFunctionalComponent1(__VLS_84, new __VLS_84({
    label: (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.prompt.label')),
    prop: "prompt",
    rules: ({
        required: true,
...
const { default: __VLS_89 } = __VLS_87.slots;
{
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
    (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.prompt.label'));
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "color-danger" },
    });
    /** @type {__VLS_StyleScopedClasses['color-danger']} */ ;
    ...
    const { default: __VLS_96 } = __VLS_94.slots;
    {
        ...
        (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.prompt.tooltip'));
        // @ts-ignore
        [$t, $t, $t, $t,];
    }
    let __VLS_98;
...
const __VLS_104 = __VLS_asFunctionalComponent1(__VLS_103, new __VLS_103({
    ...{ 'onWheel': {} },
    ...{ 'onSubmitDialog': {} },
    title: (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.prompt.label')),
...
const __VLS_112 = __VLS_asFunctionalComponent1(__VLS_111, new __VLS_111({
    label: (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.negative_prompt.label')),
    prop: "prompt",
    rules: ({
        required: false,
        message: __VLS_ctx.$t('common.prompt.placeholder'),
...
const { default: __VLS_116 } = __VLS_114.slots;
{
    ...
    const { default: __VLS_123 } = __VLS_121.slots;
    {
        ...
        (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.negative_prompt.tooltip'));
        // @ts-ignore
        [$t, $t, $t, $t,];
    }
    let __VLS_125;
...
const __VLS_131 = __VLS_asFunctionalComponent1(__VLS_130, new __VLS_130({
    ...{ 'onWheel': {} },
    ...{ 'onSubmitDialog': {} },
    title: (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.negative_prompt.label')),
    modelValue: (__VLS_ctx.form_data.negative_prompt),
    placeholder: (__VLS_ctx.$t('workflow.nodes.imageGenerateNode.negative_prompt.placeholder')),
    ...{ style: {} },
}));
