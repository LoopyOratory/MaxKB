        ...
        nodes: [
            {
                ...
                properties: {
                    ...
                    node_data: {
                        ...
                        prologue: 'Hello, I am the XXX assistant. You can ask me questions about using XXX.\n- What are the main features of XXX?\n- How is XXX priced?\n- I need to transfer to human support',
                        tts_type: 'BROWSER',
                    },
                    input_field_list: [],
                    user_input_config: {
            ...
            },
            {
                ...
                properties: {
                    ...
                    node_data: {
                        fields: [],
                        content: 'Sorry, no relevant content was found in the knowledge base. Please provide more detailed information.',
                        is_result: true,
                        reply_type: 'content',
                    },
                },
