...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ onMouseup: () => { } },
    ...{ onClick: () => { } },
    ...{ class: "custom-edge cursor" },
});
__VLS_asFunctionalDirective(__VLS_directives.vShow, {})(null, { ...__VLS_directiveBindingRestFields, value: (props.model.isHovered) }, null, null);
/** @type {__VLS_StyleScopedClasses['custom-edge']} */ ;
/** @type {__VLS_StyleScopedClasses['cursor']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.svg, __VLS_intrinsics.svg)({
    ...{ onClick: (__VLS_ctx.deleteEdge) },
    width: "22",
    height: "22",
    viewBox: "0 0 24 24",
    fill: "none",
