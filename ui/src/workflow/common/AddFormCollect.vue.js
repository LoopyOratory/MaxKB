...
const props = withDefaults(defineProps(), { title: t('common.param.addParam'), enableVisibility: false });
...
const __VLS_defaults = { title: t('common.param.addParam'), enableVisibility: false };
const __VLS_ctx = {
    ...{},
    ...{},
    ...{},
...
const __VLS_8 = __VLS_asFunctionalComponent1(__VLS_7, new __VLS_7({
    ...
    currentEditingIndex: (__VLS_ctx.currentNodeFields?.length ?? 0),
...
var __VLS_10;
{
    ...
    const __VLS_21 = {
        ...
        onClick: (...[$event]) => {
            ...
            // @ts-ignore
            [title, dialogVisible, dialogVisible, close, dynamicsFormData, nodeModel, currentNodeFields, currentNodeFields, enableVisibility,];
        },
    };
