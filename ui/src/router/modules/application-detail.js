                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.from == 'resource-management') { }
                            ...
                            return PermissionConst.APPLICATION_OVERVIEW_READ.getApplicationWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
                        if (to.path.includes('resource-management')) {
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.from == 'resource-management') { }
                            ...
                            return PermissionConst.APPLICATION_READ.getApplicationWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
            ...
            meta: {
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.from == 'resource-management') { }
                            ...
                            return new ComplexPermission([], [() => {
                                    const to = get_next_route();
                                    return PermissionConst.APPLICATION_ACCESS_READ.getApplicationWorkspaceResourcePermission(to ? to.params.id : '');
                    ...
                    () => {
                        const to = get_next_route();
                        if (to.path.includes('resource-management')) {
                            return PermissionConst.RESOURCE_APPLICATION_ACCESS_READ;
                        }
                    },
                ]
            },
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.from == 'resource-management') { }
                            ...
                            return new ComplexPermission([], [PermissionConst.APPLICATION_CHAT_USER_READ.getApplicationWorkspaceResourcePermission(to ? to.params.id : '')], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR');
                        }
                    },
                    () => {
                        const to = get_next_route();
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.from == 'resource-management') { }
                            ...
                            return PermissionConst.APPLICATION_CHAT_LOG_READ.getApplicationWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
