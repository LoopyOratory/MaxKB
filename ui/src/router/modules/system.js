    ...
    children: [
        ...
        },
        {
            ...
            meta: {
                ...
                sameRoute: 'workspace',
                permission: [
                    new ComplexPermission([RoleConst.WORKSPACE_MANAGE, RoleConst.ADMIN], [PermissionConst.WORKSPACE_WORKSPACE_READ, PermissionConst.WORKSPACE_READ], [EditionConst.IS_EE], 'OR'),
                ],
            },
        ...
        },
        {
            ...
            meta: {
                ...
                sameRoute: 'role',
                permission: [
                    new ComplexPermission([RoleConst.ADMIN, RoleConst.WORKSPACE_MANAGE.getWorkspaceRole], [PermissionConst.ROLE_READ, PermissionConst.WORKSPACE_ROLE_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                ],
            },
        ...
        },
        {
            ...
            meta: {
                ...
                parentName: 'system',
                permission: [
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.RESOURCE_APPLICATION_READ], [EditionConst.IS_EE], 'OR'),
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.RESOURCE_KNOWLEDGE_READ], [EditionConst.IS_EE], 'OR'),
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.RESOURCE_TOOL_READ], [EditionConst.IS_EE], 'OR'),
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.RESOURCE_MODEL_READ], [EditionConst.IS_EE], 'OR'),
                ],
            },
            children: [
                {
        ...
        },
        {
            ...
            meta: {
                ...
                parentName: 'system',
                permission: [
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.SHARED_KNOWLEDGE_READ], [EditionConst.IS_EE], 'OR'),
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.SHARED_TOOL_READ], [EditionConst.IS_EE], 'OR'),
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.SHARED_MODEL_READ], [EditionConst.IS_EE], 'OR'),
                ],
            },
            children: [
                {
        ...
        },
        {
            ...
            meta: {
                ...
                parentName: 'system',
                permission: [
                    new ComplexPermission([RoleConst.WORKSPACE_MANAGE, RoleConst.ADMIN], [PermissionConst.WORKSPACE_CHAT_USER_READ, PermissionConst.CHAT_USER_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                    new ComplexPermission([RoleConst.WORKSPACE_MANAGE, RoleConst.ADMIN], [PermissionConst.WORKSPACE_USER_GROUP_READ, PermissionConst.USER_GROUP_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                    new ComplexPermission([RoleConst.WORKSPACE_MANAGE, RoleConst.ADMIN], [PermissionConst.CHAT_USER_AUTH_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                ],
            },
            children: [
                {
                    ...
                    meta: {
                        ...
                        permission: [
                            new ComplexPermission([RoleConst.WORKSPACE_MANAGE, RoleConst.ADMIN], [PermissionConst.CHAT_USER_READ, PermissionConst.WORKSPACE_CHAT_USER_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                        ],
                    },
                ...
                },
                {
                    ...
                    meta: {
                        ...
                        sameRoute: 'SystemChat',
                        permission: [
                            new ComplexPermission([RoleConst.ADMIN], [PermissionConst.CHAT_USER_AUTH_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                        ],
                    },
        ...
        },
        {
            ...
            meta: {
                ...
                sameRoute: 'setting',
                permission: [
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.APPEARANCE_SETTINGS_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.LOGIN_AUTH_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
        ...
        },
        {
            ...
            meta: {
                ...
                sameRoute: 'operate',
                permission: [
                    new ComplexPermission([RoleConst.ADMIN], [PermissionConst.OPERATION_LOG_READ], [EditionConst.IS_EE, EditionConst.IS_PE], 'OR'),
                ],
            },
