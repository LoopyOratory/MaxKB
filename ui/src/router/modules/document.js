                ...
                permission: [
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return new ComplexPermission([RoleConst.USER], [
                                PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : ''),
                            ], [], 'AND');
                        }
                    },
                    () => {
                    ...
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return PermissionConst.KNOWLEDGE_DOCUMENT_READ.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return PermissionConst.KNOWLEDGE_WORKFLOW_READ.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
                    ...
                    () => {
                        const to = get_next_route();
                        if (to.params.folderId == 'share') {
                            return new ComplexPermission([RoleConst.EXTENDS_USER.getWorkspaceRole()], [PermissionConst.KNOWLEDGE_WORKFLOW_READ.getWorkspacePermission()], [], 'AND');
                        }
                    },
                    () => {
                        const to = get_next_route();
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return PermissionConst.KNOWLEDGE_PROBLEM_READ.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return PermissionConst.KNOWLEDGE_TERMBASE_READ.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
                    ...
                    () => {
                        const to = get_next_route();
                        if (to.params.folderId == 'share') {
                            return new ComplexPermission([RoleConst.EXTENDS_USER.getWorkspaceRole()], [PermissionConst.KNOWLEDGE_TERMBASE_READ.getWorkspacePermission()], [], 'AND');
                        }
                    },
                    () => {
                        const to = get_next_route();
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return PermissionConst.KNOWLEDGE_HIT_TEST_READ.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return new ComplexPermission([RoleConst.USER], [
                                PermissionConst.KNOWLEDGE.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : ''),
                            ], [EditionConst.IS_EE, EditionConst.IS_PE], 'AND');
                        }
                    },
                    () => {
                        const to = get_next_route();
                ...
                permission: [
                    ...
                    () => {
                        ...
                        if (to.params.folderId == 'shared') {
                            ...
                            return PermissionConst.KNOWLEDGE_EDIT.getKnowledgeWorkspaceResourcePermission(to ? to.params.id : '');
                        }
                    },
                    () => {
                        const to = get_next_route();
